...
import { getLogo, getDefaultAvatar, getDefaultDocAvatar } from '../../../helpers/assets.helper';
...
export class NavbarComponent implements OnInit {
  ...
  getUserName(): string {
    this.defaultAvatar = this.currentUser.data && this.currentUser.data.role == UserRole.Doctor ? getDefaultDocAvatar() : this.defaultAvatar; 
